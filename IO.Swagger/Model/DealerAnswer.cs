...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DealerAnswer :  IEquatable<DealerAnswer>
    {
        /// <summary>
        ...
        public DealerAnswer(int? DealerId = null, string Name = null, List<VehicleAnswer> Vehicles = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DealerAnswer);
        }

        /// <summary>
        /// Returns true if DealerAnswer instances are equal
        /// </summary>
        /// <param name="other">Instance of DealerAnswer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealerAnswer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
